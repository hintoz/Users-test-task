...
public class TextFieldTableViewCell<T>: Cell<T>, UITextFieldDelegate, TextFieldCell where T: Equatable, T: InputTypeInitiable {
    ...
    func configContainerView(scale: Bool = true) {
        floatLabelTextField.layer.borderWidth = 1
        floatLabelTextField.layer.cornerRadius = 5
        floatLabelTextField.layer.borderColor = UIColor.clear.cgColor
        floatLabelTextField.layer.masksToBounds = true
    ...
    lazy public var floatLabelTextField: FloatLabelTextField = { [unowned self] in
        ...
        floatTextField.backgroundColor = UIColor.white
    ...
    open override func setup() {
        ...
        floatLabelTextField.addTarget(self, action: #selector(textFieldDidChange(_:)), for: .editingChanged)
...
public class TextFloatLabelCell : TextFieldTableViewCell<String>, CellType {
